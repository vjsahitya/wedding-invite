...
function getOriginalCode(result, importerFile, root) {
	if (result.originalCode === void 0 && importerFile && root) {
		...
		if (map?.sourcesContent) result.originalCode = pickOriginalCodeFromSourcesContent(map, importerFile, root);
	}
...
//#endregion
export { ImportLocCache, addTraceImportLocations, buildCodeSnippet, buildLineIndex, createImportSpecifierLocationIndex, findImportStatementLocationFromTransformed, findOriginalUsageLocation, findPostCompileUsageLocation, normalizeSourceMap, pickOriginalCodeFromSourcesContent };
