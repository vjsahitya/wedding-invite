import { DEFAULT_PROTOCOL_ALLOWLIST, decodePath, deepEqual, encodePathLikeUrl, findLast, functionalUpdate, hasKeys, isAbsoluteUrl, isDangerousProtocol, last, nullReplaceEqualDeep, replaceEqualDeep } from "./utils.js";
	...
	constructor(options, getStoreConfig) {
		...
		this.update = (newOptions) => {
			...
			if (this.options.routeTree !== this.routeTree) {
				...
				if (process.env.NODE_ENV !== "development" && (isServer ?? this.isServer) && globalThis.__TSR_CACHE__ && globalThis.__TSR_CACHE__.routeTree === this.routeTree) {
