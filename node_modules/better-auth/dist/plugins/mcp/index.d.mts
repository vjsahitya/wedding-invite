...
declare const mcp: (options: MCPOptions) => {
  ...
  endpoints: {
    ...
    getMcpOAuthConfig: _$better_call0.StrictEndpoint<"/.well-known/oauth-authorization-server", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    }, OIDCMetadata | null>;
    getMCPProtectedResource: _$better_call0.StrictEndpoint<"/.well-known/oauth-protected-resource", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    ...
    mcpOAuthAuthorize: _$better_call0.StrictEndpoint<"/mcp/authorize", {
      method: "GET";
    ...
    mcpOAuthToken: _$better_call0.StrictEndpoint<"/mcp/token", {
      method: "POST";
    ...
    registerMcpClient: _$better_call0.StrictEndpoint<"/mcp/register", {
      method: "POST";
      body: z.ZodObject<{
    ...
    getMcpSession: _$better_call0.StrictEndpoint<"/mcp/get-session", {
      method: "GET";
      requireHeaders: true;
