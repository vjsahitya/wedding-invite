...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: _$better_call0.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    }, {
      session: {
     ...
     */
    setActiveSession: _$better_call0.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    revokeDeviceSession: _$better_call0.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
  ...
  $ERROR_CODES: {
    INVALID_SESSION_TOKEN: _$_better_auth_core_utils_error_codes0.RawError<"INVALID_SESSION_TOKEN">;
  };
};
//#endregion
