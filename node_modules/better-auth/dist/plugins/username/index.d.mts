...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _$_better_auth_core0.GenericEndpointContext | null): Promise<{
              data: {
                username: string;
  ...
  endpoints: {
    signInUsername: _$better_call0.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: _$better_call0.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
    ...
    user: {
      fields: {
        username: {
          ...
          returned: true;
          transform: {
            input(value: _$_better_auth_core_db0.DBPrimitive): string | number | boolean | Date | Record<string, unknown> | unknown[] | null | undefined;
          };
        };
        displayUsername: {
          type: "string";
