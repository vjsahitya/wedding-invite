...
declare const backupCode2fa: (opts: BackupCodeOptions) => {
  ...
  endpoints: {
     ...
     */
    verifyBackupCode: _$better_call0.StrictEndpoint<"/two-factor/verify-backup-code", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
     ...
     */
    generateBackupCodes: _$better_call0.StrictEndpoint<"/two-factor/generate-backup-codes", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    viewBackupCodes: _$better_call0.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
