...
declare const addMember: <O extends OrganizationOptions>(option: O) => _$better_call0.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
...
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => _$better_call0.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (_$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
