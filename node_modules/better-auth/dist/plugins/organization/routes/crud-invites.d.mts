...
declare const createInvitation: <O extends OrganizationOptions>(option: O) => _$better_call0.StrictEndpoint<"/organization/invite-member", {
  method: "POST";
  requireHeaders: true;
  use: (_$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
    ...
    getSession: (context: _$_better_auth_core0.GenericEndpointContext) => Promise<{
      session: {
        id: string;
        createdAt: Date;
        updatedAt: Date;
  ...
  invitation?: {
    additionalFields: infer Field extends Record<string, _$_better_auth_core_db0.DBFieldAttribute>;
  } | undefined;
...
declare const acceptInvitation: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/accept-invitation", {
  method: "POST";
  body: z.ZodObject<{
...
declare const rejectInvitation: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/reject-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const cancelInvitation: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/cancel-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const getInvitation: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/get-invitation", {
  method: "GET";
  use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const listInvitations: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/list-invitations", {
  method: "GET";
  requireHeaders: true;
  use: (_$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
 ...
 */
declare const listUserInvitations: <O extends OrganizationOptions>(options: O) => _$better_call0.StrictEndpoint<"/organization/list-user-invitations", {
  method: "GET";
  use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
