...
declare const jwt: <O extends JwtOptions>(options?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    getJwks: _$better_call0.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: _$better_call0.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
    ...
    signJWT: _$better_call0.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: _$better_call0.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
