...
declare const oidcProvider: (options: OIDCOptions) => {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<Response | {
        redirect: boolean;
        url: string;
      } | undefined>>;
    }[];
  ...
  endpoints: {
    ...
    oAuthConsent: _$better_call0.StrictEndpoint<"/oauth2/consent", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        accept: z.ZodBoolean;
     ...
     */
    registerOAuthApplication: _$better_call0.StrictEndpoint<"/oauth2/register", {
      method: "POST";
      body: z.ZodObject<{
    ...
    getOAuthClient: _$better_call0.StrictEndpoint<"/oauth2/client/:id", {
      method: "GET";
      use: _$better_call0.Middleware<_$better_call0.MiddlewareOptions, (inputContext: _$better_call0.MiddlewareInputContext<_$better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
     ...
     */
    endSession: _$better_call0.StrictEndpoint<"/oauth2/endsession", {
      method: ("GET" | "POST")[];
  ...
  readonly options: {
    ...
    getAdditionalUserInfoClaim?: ((user: _$_better_auth_core_db0.User & Record<string, any>, scopes: string[], client: Client) => Record<string, any> | Promise<Record<string, any>>) | undefined;
